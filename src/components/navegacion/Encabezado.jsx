...
import logo from "../../assets/transformer.png";
        ...
        contenidoMenu = (
            <>
                <Nav className="ms-auto pe-2">
                    ...
                    {/*opcion para ir al catalogo publico desde admin*/}
                    <Nav.Link
                        onClick={() => manejarNavegacion("/catalogo")}
                        className={mostrarMenu ? "color-texto-marca" : "text-white"}
                    >
                    ...
                    <hr />
                    {/*icono cerrar sesion en barra superior*/}
                    {mostrarMenu ? null : (
                        <Nav.Link
        ...
        <Container>
            ...
            >
                <Offcanvas.Header closeButton>
                    <Offcanvas.Title>Menu Discose</Offcanvas.Title>
                </Offcanvas.Header>
